...
export default {
    ...
    created() {
        ...
        this.PartnerInfo = this.$parent.SelectedPartner;
        ...
        //this.PartnerInfo.id = this.$parent.SelectedPartner;
        ...
        //this.customersInfo.isShared = this.custmor.isShared;
    ...
    methods: {
        ...
        editPersnalInfo() {
            ...
            this.$confirm('سيؤدي ذلك إلى تعديل بيانات الشريك  . استمر؟', 'تـحذير', {
                ...
                this.$http.EditPartnerInfo(this.PartnerInfo)
                    .then(response => {
                        this.$message({
                            type: 'info',
